...
draw bounded labels on the vector canvas. Workspace version 8 persists those
...
parsed search state and five bounded quick-view slots while importing versions
1 through 7. `/legacy` remains the
