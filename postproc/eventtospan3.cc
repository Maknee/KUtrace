...
// eBPF exposes the kernel CPU id directly. Keep this comfortably above modern
// server sizes; the fixed state is about a few hundred bytes per CPU.
static const int kMAX_CPUS = 1024;
