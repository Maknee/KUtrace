...
views in the portable version-7 workspace format, which also retains the four
...
selectors/duration bounds; version-1 through version-6 files remain importable.
