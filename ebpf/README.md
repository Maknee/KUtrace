...
views in the portable version-5 workspace format, which also retains the four
KUtrace lane groups in full, highlighted-only, or hidden states plus the
vertical row scale and position; version-1 through version-4 files remain
