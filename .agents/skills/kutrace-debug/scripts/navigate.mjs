...
try {
  ...
  const result = {
    ...
    timelineGlyphs: {
      ...
      idleRails: await page.locator('[data-overlay-glyph="idle"]').count(),
      userRails: await page.locator('[data-overlay-glyph="user-rail"]').count(),
      kernelRails: await page.locator('[data-overlay-glyph="kernel-rail"]').count(),
      waits: await page.locator('[data-overlay-glyph="wait"]').count(),
